<template>
    <div class="bounced_YN-drag">
        <div class="box bounced popup-box" data-drag="true" @click="boxZindex" :style="{'z-index': Zindex}">
            <h1 class="b_title darg-title">
                <p class="tit_left">保存场景</p>
...
import drag from '../../static/js/drag'
    export default {
        ...
        methods:{
            ...
            yes_save(){
                this.$emit('bounced_shYnend', "yes");
                // if(this.kindheader == "打开场景" )

            },
            No_opennew(){
                this.$emit('bounced_shYnend', "no");
            }
        },
        mounted:function(){
            drag('bounced_YN-drag', '')
